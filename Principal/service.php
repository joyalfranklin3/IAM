...
<body>
    ...
    <div class="gallery-container">
        <div class="gallery">
            <a href="./AGRI/agri.php" class="gallery-item">
            ...
            <a href="./AIDS/aids.php" class="gallery-item">
            ...
            <a href="./CIVIL/civil.php" class="gallery-item">
            ...
            <a href="./CSE/cse.php" class="gallery-item">
            ...
            <a href="./EEE/eee.php" class="gallery-item">
            ...
            <a href="./ECE/ece.php" class="gallery-item">
            ...
            <a href="./IT/it.php" class="gallery-item">
            ...
            <a href="./MECH/mech.php" class="gallery-item">
